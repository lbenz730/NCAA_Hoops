...
y <- read.csv("3.0_Files/Results/2017-18/NCAA_Hoops_Results_3_25_2018.csv", as.is = T)
mins <- read.csv("3.0_Files/Info/mins.csv", as.is = T)
rec <- read.csv("3.0_Files/Info/recruiting.csv", as.is = T)
transfers <- read.csv("3.0_Files/Info/transfers.csv", as.is = T)
